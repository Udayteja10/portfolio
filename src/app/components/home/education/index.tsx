        ...
        <section>
            <div className="container">
                <div className="border-x border-primary/10 dark:border-[#334155] bg-white dark:bg-[#0F172A] transition-colors duration-300">
                    ...
                    <div className="border-t border-primary/10 dark:border-[#334155]">
                        <div className="relative max-w-3xl mx-auto px-4 sm:px-0 py-10">
                            <div className="hidden sm:flex absolute left-5 sm:left-[15.9rem] sm:translate-x-1/2 top-0 bottom-0 w-px bg-primary/10 dark:bg-[#334155]" />
                                ...
                                {educationData?.map((item:any, index:any) => (
                                    ...
                                    >
                                        <div className="relative pl-8 sm:pl-0 sm:w-64 sm:text-right sm:pr-16">
                                            <p className="ml-2.5 sm:ml-0 text-base font-normal sm:mb-0 leading-relaxed text-secondary">
                                                {item.date}
                                            </p>

                                            {/* Bullet Point */}
                                            <div className="absolute left-1.5 sm:left-auto sm:-right-3 top-0 z-10 p-1.5 border border-primary/10 dark:border-[#334155] rounded-full bg-white dark:bg-[#0F172A]">
